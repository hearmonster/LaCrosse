sap.ui.define([
		...
		return BaseObject.extend("myns.model.ListSelector", {
			 ...
			 * @return {myns.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
